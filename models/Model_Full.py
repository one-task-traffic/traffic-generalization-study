...
def build_model(
    ...
    x = layers.Dense( transformer_input_size, activation='relu' )( x ) # Add dense layer before encoder stack
    x = layers.BatchNormalization()( x )
    
    x = x + positional_encoding( input_shape[ 0 ], transformer_input_size ) # Positional encoding
